...
try:
    while True:
        # Move to position 1200
        command1 = generate_command({18: 1200}, time_of_execution=2000)
        ser.write(command1.encode())
        time.sleep(2.3)  # Wait for movement to complete

        # Move to position 2000
        command2 = generate_command({18: 2000}, time_of_execution=2000)
