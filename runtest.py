...
# API configurations
asticaAPI_key = '26D0923B-C59F-47FD-995B-1336A65EF72A50F3AE12-28A2-4160-A777-B4D74EF4D20E'  # visit https://astica.ai
...
if 1 == 1:
    asticaAPI_input = get_image_base64_encoding(image_path)  # use base64 image input (slower)


# vision parameters:  https://astica.ai/vision/documentation/#parameters
asticaAPI_visionParams = 'gpt,describe,faces'  # comma separated, defaults to "all". 
